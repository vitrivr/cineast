...
public class ZernikePolynomialsTest {
  ...
  /**
   * Tests definition of Zernike Polynomials, which are only defined for n > 0, |m| <= n and n-|m| = even
   */
  @Test
  ...
  /**
   * Test Z_00, which must be equal to 1.0 + 0.0i for all values ofs r and theta.
   */
  @Test
