...
public class AudioSignalVisualizer {
  ...
  /**
   * This method visualizes a spectrogram that shows temporal development of a signals spectogram (i.e time vs. frequency vs power distribution).
   * <p>
   * x-axis: Relative time y-axis: Frequency bins color: Power in bin (dB)
   *
  ...
  /**
   * This method visualizes a chromagram that displays the temporal development of the signal's energy in one of the twelve pitch classes.
   *
  ...
  /**
   * This method visualizes a CENS chromagram, which displays the temporal development of the signal's energy in one of the twelve pitch classes.
   *
