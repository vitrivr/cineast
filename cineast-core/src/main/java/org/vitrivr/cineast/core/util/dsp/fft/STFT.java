...
public class STFT {
   ...
   * <p>
   * A value of X means that X zeros will be prepended before the signal start. Then after the actual signal, another X zeros will be appended. This means, that the window will contain windowsize-2*X samplepoints
   */
  ...
  /**
   * Performs a forward fourier transformation on the provided, real valued data and appends it to the FFT. The caller of this function must make sure, that the data conforms to the properties specified upon construction of this class. Otherwise, some results may be unexpected!
   *
  ...
  /**
   * Assembles a list of power-spectra (one per FFT contained in this STFT) and returns it.
   *
  ...
  /**
   * Assembles a list of magnitude-spectra (one per FFT contained in this STFT) and returns it.
   *
