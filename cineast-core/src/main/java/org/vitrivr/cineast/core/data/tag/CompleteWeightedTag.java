...
public class CompleteWeightedTag implements WeightedTag {
    ...
    public CompleteWeightedTag(String id, String name, String description, float weight, String preference) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return String.format("CompleteWeightedTag [id=%s, name=%s, description=%s, weight=%s]", id, name, description, weight);
    }
