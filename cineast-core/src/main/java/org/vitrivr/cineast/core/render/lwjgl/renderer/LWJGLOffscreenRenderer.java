...
/**
 * This is the top most class of the LWJGL for Java 3D renderer. Its main function is to provide an interface between
 * Engine and the outside world. It sets up the  {@link Engine} and provides the interface to the outside world.
 * {@link Renderer} It extends the abstract class {@link EngineLogic} which allows the instanced engine to call methods
 * depending on the engine state.
 */
...
public class LWJGLOffscreenRenderer extends EngineLogic implements Renderer {
   ...
   * @param opts The render options.
   */
  public void setLighting(LightingOptions opts) {
    this.engine.setLightingOptions(opts);
  }
  ...
  /**
   * Is called once at the initialization of the engine. DO NOT CALL ENGINE METHODS IN THIS METHOD DO NOT CALL THIS
  ...
  /**
   * Is called from the engine before the render method. DO NOT CALL ENGINE METHODS IN THIS METHOD DO NOT CALL THIS
   * METHOD FROM THIS CLASS
   */
  @Override
  ...
  /**
   * Is called from the engine after the render method. DO NOT CALL ENGINE METHODS IN THIS METHOD DO NOT CALL THIS
   * METHOD FROM THIS CLASS
   */
  @Override
  ...
  /**
   * Is called from the engine as first step during refresh and cleanup DO NOT CALL ENGINE METHODS IN THIS METHOD DO NOT
   * CALL THIS METHOD FROM THIS CLASS
   */
  @Override
  ...
  /**
   * This method is called every frame. This is only used in continuous rendering. The purpose is to do some input
   * handling. Could be use for optimize view  angles on a fast manner. DO NOT CALL ENGINE METHODS IN THIS METHOD DO NOT
   * CALL THIS METHOD FROM THIS CLASS
   */
  @Override
  ...
  /**
   * After Engine run This method is called every frame. This is only used in continuous rendering. The purpose is to
   * process some life output. Could be use for optimize view  angles on a fast manner. DO NOT CALL ENGINE METHODS IN
   * THIS METHOD DO NOT CALL THIS METHOD FROM THIS CLASS
   */
  @Override
