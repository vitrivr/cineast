...
public class Mesh implements WritableMesh {
  ...
  /**
   * Adds a new triangular face to the Mesh. Faces index vertices and vertex normals.
   *
  ...
  /**
   * Adds a new quadratic face to the Mesh. Faces index vertices and vertex normals.
   *
