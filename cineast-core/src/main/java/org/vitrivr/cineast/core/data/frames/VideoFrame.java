...
/**
 * Represents a single video-frame. Such a frame consist of a single image and, optionally, an {@link AudioFrame} of arbitrary length and, again optionally, a list of {@link SubtitleItem}s.
 *
 * @see AudioFrame
 */
public class VideoFrame {
  ...
  /**
   * Adds an AudioFrame to the current VideoFrame. The existing frame (if any) and the new frame are concatenated during the process.
   *
