...
public class DataURLParser {
  ...
  /**
   * Tries to convert a Base64 data URL to a JsonNode and returns that JsonNode.
   *
  ...
  /**
   * Converts a Base64 data URL to a byte array and returns it. Only URLs that contain the verify substring at position five of the String will be converted!
   *
   * @param dataUrl String containing the data url.
  ...
  /**
   * Converts a Base64 data URL to a UTF8 String and returns it. Only URLs that contain the verify substring at position five of the String will be converted!
   *
   * @param dataUrl String containing the data url.
   * @param verify  Substring that must be contained at position 5 in order for the data to be converted.
  ...
  /**
   * Checks if the provided data URL is actually a valid data URL. Returns true, if so and false otherwise.
   *
