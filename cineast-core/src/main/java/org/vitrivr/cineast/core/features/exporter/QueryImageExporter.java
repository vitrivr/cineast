...
/**
 * This class is used to store the query images (i.e. sketches) which is why it implements retriever functionality. It is not actually a retriever in the sense that it returns any results.
 */
