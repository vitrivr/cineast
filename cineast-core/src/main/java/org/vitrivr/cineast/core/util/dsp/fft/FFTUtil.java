...
public class FFTUtil {
  ...
  /**
   * Returns the center frequency associated with the provided bin-index for the given window-size and samplingrate.
   *
  ...
  /**
   * Returns the bin-index associated with the provided frequency at the given samplingrate and window-size.
   *
   * @param size         Size of the FFT (i.e. number of frequency bins).
   * @param samplingrate Rate at which the original data has been sampled.
   */
  ...
  /**
   * Returns time labels in seconds for a STFT of given width using the provided window size and samplerate.
   *
   ...
   * @param padding      Zeropadding, i.e. how many zeros have been added before and after the actual sample starts (Assumption: padding happens within the fixed windowsize)
   * @param samplingrate Rate at which the original data has been sampled.
  ...
  /**
   * Returns the width in seconds of a single FFT in an STFT i.e. how many seconds one progresses in the original signal when moving to the next FFT.
   *
  ...
  /**
   * Method that can be used to find the closest power of two value greater than or equal to the provided value. Used to introduce a zero-padding on input-data whose length is not equal to 2^n.
   *
  ...
  /**
   * Calculates and returns the windowsize in samples and the zero-padding in samples so as to achieve a certain window-duration in seconds.
   *
