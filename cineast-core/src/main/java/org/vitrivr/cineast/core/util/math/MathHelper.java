...
public class MathHelper {
  ...
  /**
   * Normalizes a float array with respect to the L2 (euclidian) norm. The method will return a new array and leave the original array unchanged.
   *
  ...
  /**
   * Normalizes a float array with respect to the L2 (Euclidian) norm. The method will perform the normalisation in place.
   *
   * @param v Array that should be normalized.
   * @return Normalized array.
   */
  ...
  /**
   * Normalizes a double array with respect to the L2 (euclidian) norm. The method will return a new array and leave the original array unchanged.
   *
   * @param v Array that should be normalized.
   * @return Normalized array.
   */
