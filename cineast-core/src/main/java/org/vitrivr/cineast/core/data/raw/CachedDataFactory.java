...
/**
 * This factory class generates {@link ByteData} objects either in memory or backed by a file cache based on a heuristic involving the size of the allocated data chunks.
 *
 * @version 1.1
 * @see ByteData
...
public class CachedDataFactory {
  ...
  /**
   * Wraps the provided byte array in a {@link ByteData} object and returns it. This method determines whether to use a {@link InMemoryByteData} or a {@link CachedByteData} object based on the size of the data object and global application settings.
   *
  ...
  /**
   * Wraps the provided byte array in a {@link CachedByteData} object and returns it. If for some reason, allocation of the {@link CachedByteData} fails, an {@link InMemoryByteData} will be returned instead.
   *
   * @param data The data that should be wrapped.
   * @return {@link ByteData} object.
  ...
  /**
   * Creates and returns a new {@link CachedMultiImage} from the provided image using the provided cache prefix. If the instantiation of the {@link CachedMultiImage} fails, the method is allowed to fallback to a {@link InMemoryMultiImage}
   *
