...
/**
 * This class can be used to to transform a 3D polygon Mesh into a 3D VoxelGrid. The class performs this transformation by applying the algorithm described in [1]. It can either use a grid of fixed size or one that dynamically fits the bounding box of the Mesh given the resolution.
 * <p>
 * The resulting VoxelGrid approximates the surface of the Mesh. The volumetric interior of the grid will not be filled!
 *
 * <p>Important:</p> The resolution of the Voxelizer and the size of the Mesh determine the accuracy of the Voxelization
 * process. For instance, if the resolution is chosen such that one Voxel has the size of the whole mesh, the Voxelization will not yield any meaningful result.
 * <p>
 * [1] Huang, J. H. J., Yagel, R. Y. R., Filippov, V. F. V., & Kurzion, Y. K. Y. (1998). An accurate method for voxelizing polygon meshes. IEEE Symposium on Volume Visualization (Cat. No.989EX300), 119–126,. http://doi.org/10.1109/SVV.1998.729593
 */
public class Voxelizer {
   ...
   *
   * @param resolution Resolution of the Voxelizer (i.e. size of a single Voxel in the grid). This is an important parameter, as it determines the quality of the Voxelization process!
   */
