...
public class ImageParser extends DataURLParser {
  ...
  /**
   * Checks, if provided data URL is a valid image. Returns true if so and  false otherwise. No structural analysis is performed! Only the raw, data URL is being checked.
   *
