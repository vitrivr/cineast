...
public interface MeshProvider {
  ...
  /**
   * Returns the original 3D Mesh. Defaults to the empty mesh, if the method hasn't been implemented.
   *
   * <strong>Important: </strong> The instance of the Mesh returned by this method is
   * potentially shared by different feature modules and Threads. Keep that in mind when applying in-place transformations on the Mesh!
   *
  ...
  /**
   * Returns a version of the 3D Mesh that has been KHL-transformed. Defaults to the empty mesh, if the method hasn't been implemented.
   *
   * <strong>Important: </strong> The instance of the Mesh returned by this method is potentially
   * shared by different feature modules and Threads. Keep that in mind when applying in-place transformations on the Mesh!
   *
