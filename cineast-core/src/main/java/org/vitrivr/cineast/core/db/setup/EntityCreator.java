...
public interface EntityCreator extends Closeable {
  ...
  /**
   * Initialises the entity responsible for holding metadata information about multimedia objects. By default, calls {@link #createMetadataEntity()} with the appropriate default object metadata table name
   */
  default boolean createMetadataEntity() {
    return createMetadataEntity(MediaObjectMetadataDescriptor.ENTITY);
  }

  /**
   * Creates an entity to hold object metadata with the specified table name.
   * <br>
  ...
  /**
   * Initialises the entity responsible for holding metadata information about multimedia segments. By default, calls {@link #createSegmentMetadataEntity()} ()} with the appropriate default segment metadata table name
   */
  default boolean createSegmentMetadataEntity() {
    return createSegmentMetadataEntity(MediaSegmentMetadataDescriptor.ENTITY);
  }

  /**
   * Creates an entity to hold segment metadata with the specified table name.
   * <br>
  ...
  /**
   * Creates and initializes an entity with the provided name and the provided attributes. The new entity will have an additional field prepended, called "id", which is of type "string" and has an index.
   *
  ...
  /**
   * Creates and initializes an entity with the provided definition.
   *
