...
/**
 * An Extraction and Retrieval module that leverages pure HPCP based CENS shingles according to [1]. These shingles can be used for cover-song and version identification.
 * <p>
 ...
 * <p>
 * [2] Kurth, F., & Müler, M. (2008). Efficient index-based audio matching. IEEE Transactions on Audio, Speech and Language Processing, 16(2), 382–395. http://doi.org/10.1109/TASL.2007.911552
 */
public abstract class CENS extends StagedFeatureModule {
  ...
  /**
   * Array of CENS(w,d) settings used at query time. One CENS feature is calculated and looked-up for every entry in this array. The inner array contains the following parameters:
   * <p>
   * 0 - Window size (w) 1 - Downsampling ratio (d)
   */
