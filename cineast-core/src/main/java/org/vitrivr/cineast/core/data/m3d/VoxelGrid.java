...
/**
 * This class represents a Voxel grid, i.e. a 3-dimensional grid of 3D pixels (called Voxels). Every voxel can either be visible or invisible.
 */
public class VoxelGrid {
  ...
  /**
   * Getter for the length of the voxel-grid i.e. the number of voxels in the grid.
   *
  ...
  /**
   * Returns the resolution of the Voxel grid, i.e. the size of a single Voxel.
   *
