...
/**
 * This class represents a single pitch as returned for instance by pitch estimation classes or used by pitch tracking classes. A pitch can be either created based on a frequency in Hz or a MIDI index.
 */
public class Pitch {
  ...
  /**
   * Calculates the distance between the current pitch and the provided pitch on a cent scale.
   *
   * @param pitch Pitch to measure the distance to.
   * @return Distance in cents.
   */
