...
public abstract class AbstractCodebookFeatureModule extends StagedFeatureModule {
  ...
  /**
   * Returns a histogram given the provided descriptors and the assignment object loaded from the codebook.
   *
  ...
  /**
   * Returns the full name of the codebook to use. All codebook be placed in the ./resources/codebooks folder.
   *
   * @return
   */
