...
/**
 * An Extraction and Retrieval module that leverages HPCP CENS shingles according to [1]. The particular module focuses on bassline frequencies following an idea found in [2].
 * <p>
