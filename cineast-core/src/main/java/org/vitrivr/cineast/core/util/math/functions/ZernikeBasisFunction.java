...
/**
 * This class represents a Zernike Basis Function of order m,n. These functions can be used to construct a Zernike Polynomial.
 */
public class ZernikeBasisFunction implements UnivariateComplexFunction {
  ...
  /**
   * Constructs a new ZernikeBasisFunction given the 1st and 2nd moment used to construct the radial polynomial associated with it.
   *
