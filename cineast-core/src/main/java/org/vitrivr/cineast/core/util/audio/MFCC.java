...
/**
 * This class calculates Mel-frequency cepstral coefficient (MFCC) features from the STFT of an audio signal. The code was partially taken from the OrangeCow Volume project. See [1]
 * <p>
 * [1] S. Pfeiffer, and C. Parker, and T. Vincent. 2005. OC Volume: Java speech recognition engine. 2005. [March 8th, 2017].
 */
public class MFCC {
  ...
  /**
   * Default constructor for MFCC class with 13 cepstra, a Mel-Filter bank of size 13 and a minimum frequency of 133.0f Hz.
   */
  public MFCC() {
    this(13, 23, 133.0f);
  }
  ...
  /**
   * Finds and returns the center frequency of the i-th mel filter out of a specified amount of filters.
   *
  ...
  /**
   * Transforms a frequency in Hz into a corresponding frequency on the mel scale and returns the value of that mel frequency.
   *
  ...
  /**
   * Transforms a mel frequency into a frequency in Hz and returns the value of that frequency.
   *
  ...
  /**
   * Calculates and returns the indices of the frequency-bins relevant for mel-filtering (relative to the full list of frequency bins).
   *
   * @param samplingrate The rate at which the original data has been sampled.
