...
public class FFT {
  ...
  /**
   * Returns the magnitude spectrum of the transformed data. If that spectrum has not been calculated yet it will be upon invocation of the method.
   *
  ...
  /**
   * Returns the power spectrum of the transformed data. If that spectrum has not been calculated yet it will be upon invocation of the method.
   *
  ...
  /**
   * Can be used to directly access a FFT coefficient at the specified index.
   *
  ...
  /**
   * Returns true if the FFT only contains zeros and false otherwise
   */
