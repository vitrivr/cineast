 ...
 * @created 10.06.21
 */
public interface ImageRequestBuilder_v3_0 {
   ...
   */
  ImageRequestBuilder_v3_0 setRegionFull();
   ...
   * @return this {@link ImageRequestBuilder_v3_0}
   */
  ImageRequestBuilder_v3_0 setSizeMaxUpscaled();
   ...
   * @return this {@link ImageRequestBuilder_v3_0}
   */
  ImageRequestBuilder_v3_0 setSizeMaxNotUpscaled();
   ...
   */
  ImageRequestBuilder_v3_0 setSizeScaledExactUpscaled(Float w, Float h) throws IllegalArgumentException;
   ...
   */
  ImageRequestBuilder_v3_0 setSizeScaledExactNotUpscaled(Float w, Float h) throws IllegalArgumentException;
   ...
   */
  ImageRequestBuilder_v3_0 setSizeScaledBestFitNotUpscaled(float w, float h, boolean isWidthOverridable, boolean isHeightOverridable) throws IllegalArgumentException;
   ...
   * @throws IllegalArgumentException Behaviour of server when both width and height are overridable is undefined
   */
  ImageRequestBuilder_v3_0 setSizeScaledBestFitUpscaled(float w, float h, boolean isWidthOverridable, boolean isHeightOverridable) throws IllegalArgumentException;
   ...
   * @return this {@link ImageRequestBuilder_v3_0}
   */
  ImageRequestBuilder_v3_0 setSizePercentageNotUpscaled(float n);
   ...
   * @return this {@link ImageRequestBuilder_v3_0}
   */
  ImageRequestBuilder_v3_0 setSizePercentageUpscaled(float n);
