...
public class Spectrum implements Iterable<Pair<Float, Double>> {
  ...
  /**
   * Calculates and returns t magnitude spectrum for the provided, complex data input (usually stemming from a FFT).
   *
   * @param data           Array of complex values to forward the spectrum from.
  ...
  /**
   * Returns a pair of frequency and the associated value at the specified index.
   *
  ...
  /**
   * Changes the value at the given index to the new, provided value.
   *
  ...
  /**
   * Find local maxima in the spectrum and returns the indices of those maxima as integer array.
   *
