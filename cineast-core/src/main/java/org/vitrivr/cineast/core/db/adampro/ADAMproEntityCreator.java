...
public class ADAMproEntityCreator implements EntityCreator {
  ...
  /**
   * Initialises the main entity holding information about multimedia objects in the ADAMpro storage engine.
   */
  @Override
  ...
  /**
   * Initialises the entity responsible for holding information about segments of a multimedia object in the ADAMpro storage engine.
   *
   * @see EntityCreator
   */
  @Override
  ...
  /**
   * Creates and initializes a new feature entity with the provided name and the provided attributes. The new entity will have a field called "id", which is of type "string" and has an index. Also, for each of the provided feature attribute a field of the type "vector" will be created.
   *
  ...
  /**
   * Creates and initializes a new feature entity with the provided name and the provided attributes. The new entity will have a field called "id", which is of type "string" and has an index.
   *
