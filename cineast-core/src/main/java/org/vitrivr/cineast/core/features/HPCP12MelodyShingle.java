...
/**
 * An Extraction and Retrieval module that leverages pure HPCP shingles according to [1]. The particular module focuses on melodic frequencies according to an idea found in [2].
 * <p>
