...
import org.vitrivr.cineast.core.extraction.decode.subtitle.cc.CCSubTitleDecoder;
import org.vitrivr.cineast.core.extraction.decode.subtitle.srt.SRTSubTitleDecoder;

/**
 * This class can be used to instantiate {@link SubTitleDecoder} instances for a given video file or subtitle file. It uses the Java reflection API and a map of suffices to decoder classes to facilitate this functionality.
 *
...
public final class SubtitleDecoderFactory {
  ...
  /**
   * Tries to return a {@link SubTitleDecoder} object for the specified video file. This method expects a separate file with the same name as the video located in the same folder. If there is a registered decoder for the file, that decoer is instantiated and returned.
   *
  ...
  /**
   * Tries to decode the subtitle located under the specified path using the specified {@link SubTitleDecoder} decoder. If this method succeeds, a new {@link SubTitleDecoder} object is returned. Otherwise, the returned optional will be empty.
   *
  ...
  /**
   * Registers a new {@link SubTitleDecoder} for a specific suffix. This method cannot be used to override already registered suffices!
   */
