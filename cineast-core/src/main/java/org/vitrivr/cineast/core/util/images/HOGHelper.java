...
/**
 * This class provides methods to extract Histogram of Oriented Gradients (HOG) features from images using the BoofCV library. The default settings for the HOG features are taken from [1].
 * <p>
 * [1] Velmurugan, K., & Santosh Baboo, S. (2011). Image Retrieval using Harris Corners and Histogram of Oriented Gradients. International Journal of Computer Applications, 24(7), 6–10. Retrieved from http://www.ijcaonline.org/journal/number14/pxc387478.pdf
 */
public final class HOGHelper {
   ...
   * <p>
   * - Number of cells: 4 in each dimension - Number of bins: 8 - Number of pixels per cell: 16 x 16
   */
