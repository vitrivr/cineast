...
public interface TimeDomainFilterInterface {
  ...
  /**
   * Applies a filter onto an array of time-domain data (samples). This method is intended for out-of-place operations i.e. a copy the original array is created before applying the filter.
   *
  ...
  /**
   * Applies a filter onto an array of time-domain data (samples). This method is intended for in-place operations i.e. alters the original array.
   *
   * @param samples Array holding the samples.
   * @return Filtered samples.
   */
