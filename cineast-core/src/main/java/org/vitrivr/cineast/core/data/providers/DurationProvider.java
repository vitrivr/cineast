...
public interface DurationProvider {
  ...
  /**
   * Returns the start in some arbitrary unit, e.g. in samples or frames depending on the implementation.
   */
  ...
  /**
   * Returns the end in some arbitrary unit, e.g. in samples or frames depending on the implementation.
   */
  default int getEnd() {
    return 0;
  }
