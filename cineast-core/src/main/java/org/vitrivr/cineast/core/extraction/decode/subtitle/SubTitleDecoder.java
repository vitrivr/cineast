...
/**
 * Represents a subtitle decoder instance. Basically, a {@link SubTitleDecoder} instance provides access to a stream of {@link SubtitleItem}s in temporal order.
 * <p>
 * The decoder uses an internal pointer that can be incremented sequentially to access the latest items. Muxing with a stream of {@link VideoFrame}s is typically done via the presentation timestamp of both the {@link VideoFrame} and {@link SubtitleItem}
 *
 * @see VideoFrame
