...
public final class DecoderConfig {
  ...
  /**
   * Returns a name decoder-property as Float. If the property is not set, the default value passed to the method is returned instead.
   *
  ...
  /**
   * Returns a name decoder-property as Integer. If the property is not set, the default value passed to the method is returned instead.
   *
   * @param name       Name of the property.
   * @param preference Preference value.
  ...
  /**
   * Returns a name decoder-property as Boolean. If the property is not set, the default value passed to the method is returned instead.
   *
   * @param name       Name of the property.
   * @param preference Preference value.
   * @return Integer value of the named property or its preference.
  ...
  /**
   * Returns a name decoder-property as String. If the property is not set, the default value passed to the method is returned instead.
   *
   * @param name       Name of the property.
   * @param preference Preference value.
