 ...
 * @created 09.06.21
 */
public interface ImageRequestBuilder_v2 {
  ...
  ImageRequestBuilder_v2 setSizeFull();
   ...
   */
  ImageRequestBuilder_v2 setRegionFull();
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setRegionSquare() throws OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setRegionAbsolute(float x, float y, float w, float h) throws OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setRegionPercentage(float x, float y, float w, float h) throws OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setSizeMax();
   ...
   */
  ImageRequestBuilder_v2 setSizeScaledExact(Float width, Float height) throws IllegalArgumentException, OperationNotSupportedException;

  /**
   * The image content is scaled for the best fit such that the resulting width and height are less than or equal to the requested width and height. The exact scaling may be determined by the service provider, based on characteristics including image quality and system performance. The dimensions of the returned image content are calculated to maintain the aspect ratio of the extracted region.
   *
   * @return this {@link ImageRequestBuilder_v2_Impl}
   * @throws IllegalArgumentException Behaviour of server when both width and height are overridable is undefined
   */
  ImageRequestBuilder_v2 setSizeScaledBestFit(float width, float height, boolean isWidthOverridable, boolean isHeightOverridable) throws IllegalArgumentException, OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setSizePercentage(float n) throws OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setRotation(float degree, boolean mirror) throws IllegalArgumentException, OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setQuality(String quality) throws OperationNotSupportedException;
   ...
   * @return this {@link ImageRequestBuilder_v2}
   */
  ImageRequestBuilder_v2 setFormat(String extension) throws OperationNotSupportedException;
