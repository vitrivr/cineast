...
public final class CottontailGrpc {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      switch (dataCase_) {
        ...
        case 7:
          if (!getVectorData()
              .equals(other.getVectorData())) return false;
          break;
        case 8:
          if (!getNullData()
              .equals(other.getNullData())) return false;
          break;
        case 0:
        default:
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      switch (vectorDataCase_) {
        ...
        case 4:
          if (!getLongVector()
              .equals(other.getLongVector())) return false;
          break;
        case 0:
        default:
      }
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              vector_.addInt(input.readInt32());
              break;
            }
            case 10: {
              int length = input.readRawVarint32();
    ...
    public static final int VECTOR_FIELD_NUMBER = 1;
    private com.google.protobuf.Internal.IntList vector_;
    /**
     * <code>repeated int32 vector = 1;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < vector_.size(); i++) {
        output.writeInt32NoTag(vector_.getInt(i));
      }
      unknownFields.writeTo(output);
    }
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < vector_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt32SizeNoTag(vector_.getInt(i));
        }
        size += dataSize;
        if (!getVectorList().isEmpty()) {
          size += 1;
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.Internal.IntList vector_ = emptyIntList();
      private void ensureVectorIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          vector_ = mutableCopy(vector_);
          bitField0_ |= 0x00000001;
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              vector_.addLong(input.readInt64());
              break;
            }
            case 10: {
              int length = input.readRawVarint32();
    ...
    public static final int VECTOR_FIELD_NUMBER = 1;
    private com.google.protobuf.Internal.LongList vector_;
    /**
     * <code>repeated int64 vector = 1;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < vector_.size(); i++) {
        output.writeInt64NoTag(vector_.getLong(i));
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < vector_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt64SizeNoTag(vector_.getLong(i));
        }
        size += dataSize;
        if (!getVectorList().isEmpty()) {
          size += 1;
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.Internal.LongList vector_ = emptyLongList();
      private void ensureVectorIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          vector_ = mutableCopy(vector_);
          bitField0_ |= 0x00000001;
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                vector_ = newBooleanList();
                mutable_bitField0_ |= 0x00000001;
              }
              vector_.addBoolean(input.readBool());
              break;
            }
            case 10: {
              int length = input.readRawVarint32();
    ...
    public static final int VECTOR_FIELD_NUMBER = 1;
    private com.google.protobuf.Internal.BooleanList vector_;
    /**
     * <code>repeated bool vector = 1;</code>
     */
    ...
    public boolean getVector(int index) {
      return vector_.getBoolean(index);
    }
    private int vectorMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < vector_.size(); i++) {
        output.writeBoolNoTag(vector_.getBoolean(i));
      }
      unknownFields.writeTo(output);
    }
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.Internal.BooleanList vector_ = emptyBooleanList();
      private void ensureVectorIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          vector_ = mutableCopy(vector_);
          bitField0_ |= 0x00000001;
      ...
      public Builder setVector(
        ...
        ensureVectorIsMutable();
        vector_.setBoolean(index, value);
        onChanged();
        return this;
      }
      /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected java.lang.Object newInstance(
        UnusedPrivateParameter unused) {
      return new AtomicLiteralBooleanPredicate();
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected java.lang.Object newInstance(
        UnusedPrivateParameter unused) {
      return new CompoundBooleanPredicate();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      switch (leftCase_) {
        case 1:
          if (!getAleft()
              .equals(other.getAleft())) return false;
          break;
        case 2:
          if (!getCleft()
              .equals(other.getCleft())) return false;
          break;
        case 0:
        default:
      }
      ...
      switch (rightCase_) {
        case 4:
          if (!getAright()
              .equals(other.getAright())) return false;
          break;
        case 5:
          if (!getCright()
              .equals(other.getCright())) return false;
          break;
        case 0:
        default:
      }
