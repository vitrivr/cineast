...
public final class CottonDMLGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage,
      ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> getInsertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Insert",
      requestType = ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage.class,
      responseType = ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage,
      ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> getInsertMethod() {
    io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage, ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> getInsertMethod;
    if ((getInsertMethod = CottonDMLGrpc.getInsertMethod) == null) {
      synchronized (CottonDMLGrpc.class) {
        if ((getInsertMethod = CottonDMLGrpc.getInsertMethod) == null) {
          CottonDMLGrpc.getInsertMethod = getInsertMethod = 
  ...
  private static volatile io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage,
      ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> getInsertStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "InsertStream",
      requestType = ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage.class,
      responseType = ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage,
      ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> getInsertStreamMethod() {
    io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage, ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> getInsertStreamMethod;
    if ((getInsertStreamMethod = CottonDMLGrpc.getInsertStreamMethod) == null) {
      synchronized (CottonDMLGrpc.class) {
        if ((getInsertStreamMethod = CottonDMLGrpc.getInsertStreamMethod) == null) {
          CottonDMLGrpc.getInsertStreamMethod = getInsertStreamMethod = 
              io.grpc.MethodDescriptor.<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage, ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus>newBuilder()
  ...
  public static abstract class CottonDMLImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage> insertStream(
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertStatus> responseObserver) {
      return asyncUnimplementedStreamingCall(getInsertStreamMethod(), responseObserver);
    }
  ...
  public static final class CottonDMLStub extends io.grpc.stub.AbstractStub<CottonDMLStub> {
    ...
    public io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.cottontail.grpc.CottontailGrpc.InsertMessage> insertStream(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getInsertStreamMethod(), getCallOptions()), responseObserver);
    }
  }
      ...
      synchronized (CottonDMLGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getInsertStreamMethod())
              .build();
        }
      }
    }
