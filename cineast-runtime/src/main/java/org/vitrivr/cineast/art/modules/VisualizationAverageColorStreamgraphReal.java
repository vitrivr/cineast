 ...
 */
public class VisualizationAverageColorStreamgraphReal extends AbstractVisualizationModule {
  public VisualizationAverageColorStreamgraphReal() {
    super();
  ...
  public String getDisplayName() {
    return "VisualizationAverageColorStreamgraphReal";
  }
  ...
  protected String visualizeMulti(List<Map<String, PrimitiveTypeProvider>> featureData){
    ...
    graph.add("name", "VisualizationAverageColorStreamgraphReal");
