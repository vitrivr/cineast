 ...
 */
public class VisualizationDominantColorSunburstReal extends AbstractVisualizationModule {
  public VisualizationDominantColorSunburstReal() {
    super();
  ...
  public String getDisplayName() {
    return "VisualizationDominantColorSunburstReal";
  }
  ...
  protected String visualizeMulti(List<Map<String, PrimitiveTypeProvider>> featureData){
    ...
    graph.add("name", "VisualizationDominantColorSunburst");
