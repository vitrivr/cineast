...
import org.vitrivr.cineast.standalone.importer.redhen.HandPreEmbedImportHandler;
...
public class ImportCommand implements Runnable {
  ...
  public void run() {
    ...
    switch (type) {
      ...
      case POSEHDF5:
        ...
        break;
      case HANDPREEMBED:
        handler = new HandPreEmbedImportHandler(this.threads, this.batchsize, false);
        break;
      case HANDPREEMBEDJSON:
        handler = new HandPreEmbedImportHandler(this.threads, this.batchsize, true);
        break;
      case REDHENSUB:
  ...
  private enum ImportType {
    PROTO, JSON, LIRE, ASR, OCR, AUDIO, TAGS, VBS2020, METADATA, AUDIOTRANSCRIPTION, CAPTIONING, GOOGLEVISION, V3C1CLASSIFICATIONS, V3C1COLORLABELS, V3C1FACES, V3C1ANALYSIS, OBJECTINSTANCE, LSCMETA, LSCCONCEPT, LSCCAPTION, POSEHDF5, HANDPREEMBED, HANDPREEMBEDJSON, REDHENSUB, REDHENOCR
  }
}
