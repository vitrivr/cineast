...
public class EvaluationConfig {
  ...
  /**
   * Evaluation mode determines how files should be selected; - COMPLETE: All files in the test files folder. - RANDOM: Random selection of files from the test files folder.
   */
