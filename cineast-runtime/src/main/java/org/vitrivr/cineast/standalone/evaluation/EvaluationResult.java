...
/**
 * Helper class that can be used to track evaluation results. It tracks the total number of relevant documents per class, the number of retrieved documents and the number of hits at every rank k.
 */
public class EvaluationResult {
  ...
  /**
   * Registers a new document from the resultset alongside with the information whether it was a hit or not. Updates the retrieval statistics.
   *
  ...
  /**
   * Returns true, if the number of retrieved & relevant documents equals the total number of relevant documents.
   */
  public boolean done() {
