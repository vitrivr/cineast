...
public class AdamSearchGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.adam.http.AdamGrpc.IndexNameMessage,
      ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage> METHOD_CACHE_INDEX =
  ...
  public static final io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage,
      ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage> METHOD_CACHE_ENTITY =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
  ...
  @io.grpc.ExperimentalApi
  public static final io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage,
      ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> METHOD_PREVIEW =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "AdamSearch", "Preview"),
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage.getDefaultInstance()));
  @io.grpc.ExperimentalApi
  public static final io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage,
      ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> METHOD_DO_QUERY =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "AdamSearch", "DoQuery"),
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage.getDefaultInstance()));
  @io.grpc.ExperimentalApi
  public static final io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage,
      ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> METHOD_DO_PROGRESSIVE_QUERY =
      io.grpc.MethodDescriptor.create(
          ...
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage.getDefaultInstance()));
  @io.grpc.ExperimentalApi
  public static final io.grpc.MethodDescriptor<ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage,
      ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> METHOD_GET_CACHED_RESULTS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "AdamSearch", "GetCachedResults"),
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage.getDefaultInstance()));
  ...
  public static interface AdamSearch {
    ...
    public void cacheIndex(ch.unibas.dmi.dbis.adam.http.AdamGrpc.IndexNameMessage request,
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage> responseObserver);

    public void cacheEntity(ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage request,
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage> responseObserver);

    public void preview(ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage request,
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> responseObserver);

    public void doQuery(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage request,
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> responseObserver);

    public void doProgressiveQuery(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage request,
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> responseObserver);

    public void getCachedResults(ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage request,
        io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> responseObserver);
  }

  public static interface AdamSearchBlockingClient {

    public ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage cacheIndex(ch.unibas.dmi.dbis.adam.http.AdamGrpc.IndexNameMessage request);

    public ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage cacheEntity(ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage request);

    public ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage preview(ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage request);

    public ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage doQuery(ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage request);

    public java.util.Iterator<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> doProgressiveQuery(
        ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage request);

    public ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage getCachedResults(ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage request);
  }

  public static interface AdamSearchFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage> cacheIndex(
        ch.unibas.dmi.dbis.adam.http.AdamGrpc.IndexNameMessage request);

    public com.google.common.util.concurrent.ListenableFuture<ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage> cacheEntity(
        ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage request);

    public com.google.common.util.concurrent.ListenableFuture<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> preview(
        ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage request);

    public com.google.common.util.concurrent.ListenableFuture<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> doQuery(
        ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage request);

    public com.google.common.util.concurrent.ListenableFuture<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage> getCachedResults(
        ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage request);
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CACHE_INDEX:
          serviceImpl.cacheIndex((ch.unibas.dmi.dbis.adam.http.AdamGrpc.IndexNameMessage) request,
              (io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage>) responseObserver);
          break;
        case METHODID_CACHE_ENTITY:
          serviceImpl.cacheEntity((ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage) request,
              (io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.AckMessage>) responseObserver);
          break;
        case METHODID_PREVIEW:
          serviceImpl.preview((ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage) request,
              (io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>) responseObserver);
          break;
        case METHODID_DO_QUERY:
          serviceImpl.doQuery((ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage) request,
              (io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>) responseObserver);
          break;
        case METHODID_DO_PROGRESSIVE_QUERY:
          serviceImpl.doProgressiveQuery((ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage) request,
              (io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>) responseObserver);
          break;
        case METHODID_GET_CACHED_RESULTS:
          serviceImpl.getCachedResults((ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage) request,
              (io.grpc.stub.StreamObserver<ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(SERVICE_NAME)
        ...
        .addMethod(
          ...
          asyncUnaryCall(
            new MethodHandlers<
              ch.unibas.dmi.dbis.adam.http.AdamGrpc.EntityNameMessage,
              ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>(
                serviceImpl, METHODID_PREVIEW)))
        .addMethod(
          METHOD_DO_QUERY,
          asyncUnaryCall(
            new MethodHandlers<
              ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryMessage,
              ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>(
        ...
        .addMethod(
          ...
          asyncUnaryCall(
            new MethodHandlers<
              ch.unibas.dmi.dbis.adam.http.AdamGrpc.CachedResultsMessage,
              ch.unibas.dmi.dbis.adam.http.AdamGrpc.QueryResultsMessage>(
