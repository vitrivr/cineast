...
// */
//public class FindBoolQueryElementsGetHandler implements GetRestHandler<BooleanLookupResult> {
//
//
...
//
//    public static final String ROUTE = "find/boolean/range/all/in/:" + TABLE_NAME + "/:" + TABLE_COLUMN + "/:" + TABLE_VALUE;
//
//    @Override
...
//        final String value = parameters.get(TABLE_COLUMN);
//        TObjectDoubleHashMap<Retriever> retrievers = Config.sharedConfig().getRetriever()
//                .getRetrieversByCategory("boolean").forEach(retriever -> {
//                    BooleanRetriever r = (BooleanRetriever) retriever;
//                    r.getAttributes().contains(value);
//                    final BooleanReader service = new BooleanReader(this.selector,
//                            table, column, r);
//                    results = service.getTotal();
//                    return new BooleanLookupResult("",0,content);service.getTotal();
//                });
//    }
//
//    @Override
...
//                    op.operationId("findBoolElements");
//                    op.addTagsItem("Misc");
//                })
