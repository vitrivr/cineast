...
/**
 * Documented {@link RestHandler}, providing OpenAPI documentation about itself. Due to the API setup, we rely on this documentation to actually produce the OpenAPI specs.
 *
 * <h2>Usage</h2>
 * Implementing handlers have to provide documentation in the form of an {@link OpenApiDocumentation} object. The following snipped shows how to produce such documentation:
 * <pre>
