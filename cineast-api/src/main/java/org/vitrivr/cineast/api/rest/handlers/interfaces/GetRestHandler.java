 ...
 *
 * The handler's {@link #doGet(Context)} will produce a result of the specified type {@code T},
 ...
 * method is overridden, such that this handler's {@link #get(Context)} is called, which will write the
 * result of this handler's {@link #doGet(Context)} as JSON to the context.
 *
