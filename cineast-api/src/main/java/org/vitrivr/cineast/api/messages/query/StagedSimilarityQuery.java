 ...
 */
public class StagedSimilarityQuery extends AbstractMessage {
   ...
   */
  public StagedSimilarityQuery(@JsonProperty(value = "stages", required = true) List<QueryStage> stages, @JsonProperty(value = "config", required = false) QueryConfig config) {
    this.stages = stages;
    this.config = config;
  }
