 ...
 * <p>
 * The handler's {@link #doDelete(Context)} will produce a result of the specified type {@code T}, which the REST API will send as JSON.
 *
 * <h2>Architecture</h2>
 * Ultimately, this is a {@link io.javalin.http.Handler} whose {@link io.javalin.http.Handler#handle(Context)} method is overridden, such that this handler's {@link #delete(Context)} is called.
 * <p>
