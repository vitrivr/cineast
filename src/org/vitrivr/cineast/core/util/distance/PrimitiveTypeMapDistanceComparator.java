...
public class PrimitiveTypeMapDistanceComparator implements Comparator<Map<String, PrimitiveTypeProvider>> {

  private final String vectorName;
  private final FloatArrayDistanceComparator comp;
  
  public PrimitiveTypeMapDistanceComparator(String vectorName, float[] query, FloatArrayDistance distance){
    if(vectorName == null){
  ...
  public int compare(Map<String, PrimitiveTypeProvider> o1, Map<String, PrimitiveTypeProvider> o2) {
    ...
    if(o1.containsKey("distance") && o2.containsKey("distance")){
      ...
      compare = comp.compare(o1.get(vectorName).getFloatArray(), o2.get(vectorName).getFloatArray());
    }
    if(compare != 0){
      return compare;
    }
