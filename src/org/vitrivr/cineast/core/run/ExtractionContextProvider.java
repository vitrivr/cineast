...
public interface ExtractionContextProvider {
  ...
  /**
   * Returns the ExistenceCheck mode that should be applied during the extraction run. Can either
   * be:
   *
   * NOCHECK          - No checks performed (may cause DB error if collision occurs). CHECK_SKIP
   *   - Check existence and skip object on collision. CHECK_PROCEED    - Check existence and
   * proceed with object on collision.
   *
