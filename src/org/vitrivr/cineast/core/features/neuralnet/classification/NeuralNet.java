 ...
 * <p>
 * Maybe this needs a Top-1 method if some NN Implementation doen't like to give the entire probability-array
...
public interface NeuralNet extends LabelProvider {
     ...
     *
     * @return a vector of probabilities. Labels for indicies should be provided by the LabelProvider
     */
