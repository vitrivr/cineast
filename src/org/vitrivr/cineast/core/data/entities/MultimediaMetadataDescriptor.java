...
public class MultimediaMetadataDescriptor implements ExistenceCheck {
     ...
     */
    private static final List<Class<?>> SUPPORTED_TYPES = ImmutableList.of(Integer.class, Long.class, Float.class, Double.class, Short.class, Byte.class, String.class);
     ...
     *                 Int, Long and String are supported officially.
     */
    public MultimediaMetadataDescriptor(String objectId, String domain, String key, @Nullable Object value, boolean exists) {
