...
public class CorrespondenceFunction implements DoubleUnaryOperator {
  ...
  public static CorrespondenceFunction linear(double maximumDistance) {
    checkArgument(maximumDistance > 0, "Maximum distance cannot be zero or smaller than zero, but found: " + maximumDistance);
  ...
  public static CorrespondenceFunction hyperbolic(double divisor) {
    checkArgument(divisor > 0, "Hyperbolic divisor cannot be zero or smaller than zero, but found: " + divisor);
