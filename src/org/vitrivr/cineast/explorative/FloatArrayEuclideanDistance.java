...
public class FloatArrayEuclideanDistance
  ...
  private static final long serialVersionUID = 1425234817173826631L;
  private static final Logger LOGGER = LogManager.getLogger();
  private static transient Map<HCTFloatVectorValue, Map<HCTFloatVectorValue, Double>> cache = new HashMap<>(
      1000000);
  ...
  private static void storeInCache(HCTFloatVectorValue point1, HCTFloatVectorValue point2,
      double dist) {
    if (!cache.containsKey(point1)) {
