...
public class VisualizationDominantEdgeGrid8 extends AbstractVisualizationModule {
  ...
  public String getDisplayName() {
    return "VisualizationDominantEdgeGrid8";
  }

  public static void main(String[] args) {
    VisualizationDominantEdgeGrid8 module = new VisualizationDominantEdgeGrid8();
    ...
    System.out.println(module.visualizeSegment("655367"));
  ...
  public String visualizeSegment(String segmentId) {
    ...
    try {
      ImageIO.write(image, "png", new File("src/resources/imageDominantEdgeGrid8.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
